...
import { evaluateRule, type RuleDefinition, type RuleFileInfo } from '../../shared/rules.js'
...
function buildFilename(fileInfo: RuleFileInfo, pattern: string) {
...
export function applyUserRule(rule: RuleDefinition, fileInfo: RuleFileInfo) {
