...
electron_1.contextBridge.exposeInMainWorld('api', {
    ...
    enqueueProposedActions: (actions) => electron_1.ipcRenderer.invoke('automation:enqueueProposedActions', actions),
    ...
    resolveFolderTarget: (basePath, folderName) => electron_1.ipcRenderer.invoke('folders:resolveTarget', basePath, folderName),
    listCreatedFolders: () => electron_1.ipcRenderer.invoke('folders:listCreated'),
    updateCreatedFolder: (itemId, updates) => electron_1.ipcRenderer.invoke('folders:updateMeta', itemId, updates),
    renameCreatedFolder: (itemId, nextName) => electron_1.ipcRenderer.invoke('folders:rename', itemId, nextName),
    openPath: (targetPath) => electron_1.ipcRenderer.invoke('files:open', targetPath),
    selectFile: () => electron_1.ipcRenderer.invoke('files:select'),
